...
<details>
  ...
  4. Пишите в появившийся чат и модель должна вам ответить (если вы используете GUI, если нет, то установити SillyTavern и подключите её к SMSA через localhost:8089/v1)
