...
Добавляет функции интерфейса llm (с поддержкой мультимодальных моделей в плане обработки картинок), работы с базой данных, проксирования запросов, интерфейс gui и другие.
